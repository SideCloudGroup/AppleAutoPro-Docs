...
```bash
bash <(curl -Ls https://ghfast.top/raw.githubusercontent.com/sahuidhsu/selenium-grid-docker/main/wd.sh)
```
...
```bash
bash <(curl -Ls https://ghfast.top/raw.githubusercontent.com/SideCloudGroup/AppleAutoPro-Backend/main/install.sh)
```
